...
class Scatterplot(A):
    ...
    def plot_line(self, ax, x, y, l_label, l_label2): 
        ...
        facecolor=self.__P.facecolors(self.idx), label=le_label)
            ...
            if self.__analysistype == A.agent:
                ...
                for m in minor_index:
                    ...
                    for r in range(0, len(dframe)/self.__N):
                        self.plot_line(ax, y1[r], y2[r], legend_label[0]+'_inst_'+str(r), legend_label[1]+'_inst_'+str(r) )
